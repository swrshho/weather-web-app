...
let pressure = document.querySelector('.weather__indicator--presure>.value');
let image = document.querySelector('.weather__image');
let temperature = document.querySelector('.weather__temperature');
let forecastBlock = document.querySelector('.weather__forcast');
let suggestions = document.querySelector('#suggestions');
let weatherAPIkey = "13cc3797c0c20008e4e56c1f17fc2984";
...
let weatherImages = [
  ...
  {
    url:'shower-rain.png',
    ids:[521, 521, 522, 531, 300, 301, 302, 310, 311, 312, 313, 314, 321]
  },
  {
    url: 'images.snow.png',
    ids:[511, 600, 601, 602, 611, 612, 613, 614, 615, 620, 621, 622]
  },
  {
...
let init = () => {
  weatherForCity('Tehran').then(() => document.body.style.filter = 'blur(0)');
}
  ...
  forcast.forEach(day => {
    ...
    let forcastItem = `
      <article class="weather__forcast__item">
        ...
        <p class="weather__forcast__temperatur">${temperature}</p>
      </article>
    `;
